          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            >
              ...
              >
                ...
                <span className="text-foreground">Clothes that are actually good</span>
              ...
              <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
                Quality shawls, bedsheets, t-shirts, winter wear and daily essentials. Honest pricing, reliable comfort, and designs your family has trusted for years.
              </p>
                ...
                <div className="relative group">
                  ...
                  <div className="relative flex items-center bg-card rounded-2xl border border-border/50 shadow-lg overflow-hidden">
                    ...
                    <Input
                      ...
                      placeholder="Search for bedsheet,shawl,t-shirt..."
